...
The `runtime/app.php` file creates the application instance and
...
Register a termination callback in `runtime/app.php` when you need
...
2. The application is bootstrapped from `runtime/app.php`.
