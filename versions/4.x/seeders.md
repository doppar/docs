...
Seed classes are stored in the `schema/seeders` directory, and you can use them to define the data that should be inserted into your database tables.
...
```
This will generate a new UserSeeder class in the `schema/seeders` directory, where you can define the logic for seeding the users table with data. Now it will generate a file like.
```php
<?php
