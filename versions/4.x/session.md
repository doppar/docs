...
## Configuration
Your application's session configuration file is stored at `runtime/config/session.php`. Be sure to review the options available to you in this file. By default, Doppar is configured to use the `file` session driver.
