...
In your application's `runtime/config/app.php`, add the Twig bridge launcher to the `launchers` array:

```php
'launchers' => [
    Doppar\TwigBridge\TwigLauncher::class,
],
```
...
The Twig bridge launcher binds a custom controller that extends Doppar's base controller and decides, at render time, whether to use the original Odo engine or Twig.
...
Example file: `templates/views/hello.html.twig`
